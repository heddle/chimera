...
/**
 * Represents a general curve in 3D space.
 * The curve will be on the face of a rectangular prism (cell),
 * and on the surface of the sphere of radius R. It
 * is not a grate circle.
 */
public class GeneralCurve implements Curve, ISegment {
	...
	public enum CurveType {GENERAL, CONSTANT_THETA, CONSTANT_PHI};
    ...
    /**
     * Returns a UnivariateFunction for the polar angle theta(t) (in radians)
     * To be used in apache common maths integrator.
    ...
    /**
     * Returns a UnivariateFunction for the azimuthal angle phi(t) (in radians)
     * in standard spherical coordinates.
     * To be used in apache common maths integrator.
     */
